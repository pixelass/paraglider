...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}exports.__esModule=!0;var _extends2=require(10),_extends3=_interopRequireDefault(_extends2),_wrapper=require(84),_wrapper2=_interopRequireDefault(_wrapper),belt=function(e,t){return(0,_wrapper2.default)(e,(0,_extends3.default)({},t,{onSlide:function(e,r,n){var s=r.next,a=r.previous,o=r.current,u=r.rest;null!==a?(n[a].style.transform="translate3d("+(100*e-100)+"%,0,0)",n[o].style.transform="translate3d("+100*e+"%,0,0)"):null!==s&&(n[s].style.transform="translate3d("+(100-100*e)+"%,0,0)",n[o].style.transform="translate3d("+-100*e+"%,0,0)"),"function"==typeof t.onSlide&&t.onSlide(e,{next:s,previous:a,current:o,rest:u},n)},onEnd:function(e,r){var n=e.next,s=e.previous,a=e.current,o=e.rest;o.forEach(function(e){r[e].style.transform=""}),r[a].style.transform="",r[s].style.transform="translate3d(-100%,0,0)",r[n].style.transform="translate3d(100%,0,0)","function"==typeof t.onEnd&&t.onEnd({next:n,previous:s,current:a,rest:o},r)}}))};exports.default=belt;

},{"10":10,"84":84}],78:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}exports.__esModule=!0;var _extends2=require(10),_extends3=_interopRequireDefault(_extends2),_wrapper=require(84),_wrapper2=_interopRequireDefault(_wrapper),coverLeftRight=function(e,r){return(0,_wrapper2.default)(e,(0,_extends3.default)({},r,{onSlide:function(e,t,n){var s=t.next,o=t.previous,u=t.current,a=t.rest;null!==o?n[o].style.transform="translate3d("+(100*e-100)+"%,0,0)":null!==s&&(n[s].style.transform="translate3d("+(100-100*e)+"%,0,0)"),"function"==typeof r.onSlide&&r.onSlide(e,{next:s,previous:o,current:u,rest:a},n)},onEnd:function(e,t){var n=e.next,s=e.previous,o=e.current,u=e.rest;u.forEach(function(e){t[e].style.transform=""}),t[o].style.transform="",t[s].style.transform="translate(-100%,0,0)",t[n].style.transform="translate(100%,0,0)","function"==typeof r.onEnd&&r.onEnd({next:n,previous:s,current:o,rest:u},t)}}))};exports.default=coverLeftRight;

},{"10":10,"84":84}],79:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}exports.__esModule=!0;var _extends2=require(10),_extends3=_interopRequireDefault(_extends2),_wrapper=require(84),_wrapper2=_interopRequireDefault(_wrapper),coverLeft=function(e,r){return(0,_wrapper2.default)(e,(0,_extends3.default)({},r,{onSlide:function(e,t,n){var s=t.next,o=t.previous,u=t.current,a=t.rest;null!==o?n[o].style.transform="translate3d("+(100*e-100)+"%,0,0)":null!==s&&(n[s].style.transform="translate3d("+(100*e-100)+"%,0,0)"),"function"==typeof r.onSlide&&r.onSlide(e,{next:s,previous:o,current:u,rest:a},n)},onEnd:function(e,t){var n=e.next,s=e.previous,o=e.current,u=e.rest;u.forEach(function(e){t[e].style.transform=""}),t[o].style.transform="",t[s].style.transform="translate(-100%,0,0)",t[n].style.transform="translate(100%,0,0)","function"==typeof r.onEnd&&r.onEnd({next:n,previous:s,current:o,rest:u},t)}}))};exports.default=coverLeft;

},{"10":10,"84":84}],80:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}exports.__esModule=!0;var _extends2=require(10),_extends3=_interopRequireDefault(_extends2),_wrapper=require(84),_wrapper2=_interopRequireDefault(_wrapper),coverRight=function(e,r){return(0,_wrapper2.default)(e,(0,_extends3.default)({},r,{onSlide:function(e,t,n){var s=t.next,o=t.previous,u=t.current,a=t.rest;null!==o?n[o].style.transform="translate3d("+(100-100*e)+"%,0,0)":null!==s&&(n[s].style.transform="translate3d("+(100-100*e)+"%,0,0)"),"function"==typeof r.onSlide&&r.onSlide(e,{next:s,previous:o,current:u,rest:a},n)},onEnd:function(e,t){var n=e.next,s=e.previous,o=e.current,u=e.rest;u.forEach(function(e){t[e].style.transform=""}),t[o].style.transform="",t[s].style.transform="translate(-100%,0,0)",t[n].style.transform="translate(100%,0,0)","function"==typeof r.onEnd&&r.onEnd({next:n,previous:s,current:o,rest:u},t)}}))};exports.default=coverRight;

},{"10":10,"84":84}],81:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}exports.__esModule=!0,exports.coverLeftRight=exports.coverRight=exports.coverLeft=exports.belt=exports.multiBelt=void 0;var _multiBelt=require(82),_multiBelt2=_interopRequireDefault(_multiBelt),_belt=require(77),_belt2=_interopRequireDefault(_belt),_coverLeft=require(79),_coverLeft2=_interopRequireDefault(_coverLeft),_coverRight=require(80),_coverRight2=_interopRequireDefault(_coverRight),_coverLeftRight=require(78),_coverLeftRight2=_interopRequireDefault(_coverLeftRight);exports.multiBelt=_multiBelt2.default,exports.belt=_belt2.default,exports.coverLeft=_coverLeft2.default,exports.coverRight=_coverRight2.default,exports.coverLeftRight=_coverLeftRight2.default;

},{"77":77,"78":78,"79":79,"80":80,"82":82}],82:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}exports.__esModule=!0;var _extends2=require(10),_extends3=_interopRequireDefault(_extends2),_multiWrapper=require(83),_multiWrapper2=_interopRequireDefault(_multiWrapper),multiBelt=function(t,e){return(0,_multiWrapper2.default)(t,(0,_extends3.default)({},e,{onInit:function(t,e){var r=(t.next,t.previous,t.current);t.rest;r.forEach(function(t,r){e[t].style.transform="translate3d("+100*r+"%,0,0)"})},onSlide:function(t,e,r,n){var a=e.next,l=e.previous,s=e.current,u=(e.rest,n.slideBy);null!==l?(s.length>0?s.forEach(function(e,n){r[e].style.transform="translate3d("+(100*n+100*t)+"%,0,0)"}):r[s].style.transform="translate3d("+100*t+"%,0,0)",l.length>0?l.forEach(function(e,n){r[e].style.transform="translate3d("+(-100*(u-1)+100*n+100*t-100)+"%,0,0)"}):r[l].style.transform="translate3d("+(100*t-100)+"%,0,0)"):null!==a&&(s.length>0?s.forEach(function(e,n){r[e].style.transform="translate3d("+(100*n-100*t)+"%,0,0)"}):r[s].style.transform="translate3d("+-100*t+"%,0,0)",a.length>0?a.forEach(function(e,n){r[e].style.transform="translate3d("+(100*u+100*n-100*t)+"%,0,0)"}):r[a].style.transform="translate3d("+(100-100*t)+"%,0,0)")},onEnd:function(t,e){var r=(t.next,t.previous,t.current);t.rest;e.forEach(function(t){t.style.transform="",t.style.zIndex=""}),r.forEach(function(t,r){e[t].style.transform="translate3d("+100*r+"%,0,0)"})}}))};exports.default=multiBelt;

},{"10":10,"83":83}],83:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}exports.__esModule=!0;var _extends2=require(10),_extends3=_interopRequireDefault(_extends2),_glider=require(75),_glider2=_interopRequireDefault(_glider),_config=require(73),_helpers=require(76),multiWrapper=function(e,i){if(e){var t=(0,_helpers.findFirst)("."+i.classNames.nextButton,e),n=(0,_helpers.findFirst)("."+i.classNames.prevButton,e),r=(0,_extends3.default)({},_config.PLUGIN_DEFAULTS,_config.PRESET_DEFAULTS,i),s=(0,_extends3.default)({},r,{slideBy:Math.min(r.visibleSlides,Math.max(1,r.slideBy)),onInit:function(e,i,t){var n=e.next,s=e.previous,l=e.current,o=e.rest,d=t.visibleSlides,u=t.slideBy;i.forEach(function(e){e.style.width=100/d+"%"}),"function"==typeof r.onInit&&r.onInit({next:n,previous:s,current:l,rest:o},i,{visibleSlides:d,slideBy:u})},onDestroy:function(){"function"==typeof r.onDestroy&&r.onDestroy()},onSlide:function(e,i,t,n){var s=i.next,l=i.previous,o=i.current,d=i.rest,u=n.visibleSlides,f=n.slideBy;"function"==typeof r.onSlide&&r.onSlide(e,{next:s,previous:l,current:o,rest:d},t,{visibleSlides:u,slideBy:f})},onEnd:function(e,i,t){var n=e.next,s=e.previous,l=e.current,o=e.rest,d=t.visibleSlides,u=t.slideBy;"function"==typeof r.onEnd&&r.onEnd({next:n,previous:s,current:l,rest:o},i,{visibleSlides:d,slideBy:u})}}),l=new _glider2.default(s);return l.init(e),t&&t.addEventListener("click",l.nextSlide),n&&n.addEventListener("click",l.prevSlide),l.destroy}};exports.default=multiWrapper;

},{"10":10,"73":73,"75":75,"76":76}],84:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}exports.__esModule=!0;var _extends2=require(10),_extends3=_interopRequireDefault(_extends2),_glider=require(75),_glider2=_interopRequireDefault(_glider),_config=require(73),_helpers=require(76),wrapper=function(e,t){if(e){var r=(0,_helpers.findAll)("."+t.classNames.dot,e),n=(0,_helpers.findFirst)("."+t.classNames.nextButton,e),i=(0,_helpers.findFirst)("."+t.classNames.prevButton,e),s=(0,_extends3.default)({},_config.PLUGIN_DEFAULTS,_config.PRESET_DEFAULTS,t,{onSlide:function(e,r,n){var i=r.next,s=r.previous,a=r.current,l=r.rest;"function"==typeof t.onSlide&&t.onSlide(e,{next:i,previous:s,current:a,rest:l},n)},onEnd:function(e,n){var i=e.next,s=e.previous,a=e.current,l=e.rest;r.forEach(function(e,r){r===a?e.classList.add(t.classNames.active):e.classList.remove(t.classNames.active)}),"function"==typeof t.onEnd&&t.onEnd({next:i,previous:s,current:a,rest:l},n)}}),a=new _glider2.default(s);return a.init(e),r.forEach(function(e,r){var n=function(e){return e.preventDefault(),a.goTo(r)};e.addEventListener("click",n),r===s.initialSlide?e.classList.add(t.classNames.active):e.classList.remove(t.classNames.active)}),n&&n.addEventListener("click",a.nextSlide),i&&i.addEventListener("click",a.prevSlide),a.destroy}};exports.default=wrapper;

},{"10":10,"73":73,"75":75,"76":76}]},{},[2]);
