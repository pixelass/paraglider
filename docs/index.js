...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var _from=require(4),_from2=_interopRequireDefault(_from),_easingUtils=require(74),_wrapper=require(78),_wrapper2=_interopRequireDefault(_wrapper);require(3);var _index=require(1),_index2=_interopRequireDefault(_index),classNames={pluginLoaded:_index2.default.pluginLoaded,current:_index2.default.current,previous:_index2.default.previous,next:_index2.default.next,init:_index2.default.init,active:_index2.default.active,slides:_index2.default.jsWrapper,slide:_index2.default.jsSlide,dot:_index2.default.jsDot,prevButton:_index2.default.jsPrev,nextButton:_index2.default.jsNext},parallaxSlider=function(e){var r=(0,_from2.default)(document.querySelectorAll("."+_index2.default.slide)).map(function(e){return(0,_from2.default)(e.querySelectorAll("."+_index2.default.cube))});return(0,_wrapper2.default)(e,{classNames:classNames,onSlide:function(e,t,n){var a=t.next,i=t.previous;t.current;t.rest.forEach(function(e){n[e].style.transform=""}),null!==i?(n[i].style.transform="translate3d(0,0,0)",r[i].forEach(function(t,n){var a=(r[i].length-n-1)%6+1,l=Math.pow(1-e,a);t.style.transformOrigin="0 100%",t.style.transform="rotate3d(0,1,0,"+-180*(0,_easingUtils.easeOutSine)(l)+"deg)"})):null!==a&&(n[a].style.transform="translate3d(0,0,0)",r[a].forEach(function(r,t){var n=t%6+1,a=Math.pow(1-e,n);r.style.transformOrigin="100% 100%",r.style.transform="rotate3d(0,1,0,"+-180*(0,_easingUtils.easeOutSine)(a)+"deg)"}))},onEnd:function(e,t){var n=e.current;t.forEach(function(e){e.style.transform=""}),r[n].forEach(function(e){e.style.transform=""})}})},sliders=(0,_from2.default)(document.querySelectorAll("."+_index2.default.parallax));sliders.forEach(function(e){parallaxSlider(e)});

},{"1":1,"3":3,"4":4,"74":74,"78":78}],3:[function(require,module,exports){
module.exports = {}
