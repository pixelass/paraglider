...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var _extends2=require("babel-runtime/helpers/extends"),_extends3=_interopRequireDefault(_extends2),_from=require("babel-runtime/core-js/array/from"),_from2=_interopRequireDefault(_from),_easingUtils=require("easing-utils"),_presets=require("../src/presets"),_wrapper=require("../src/presets/wrapper"),_wrapper2=_interopRequireDefault(_wrapper),_main=require("./main.css"),_main2=_interopRequireDefault(_main),classNames={pluginLoaded:_main2.default.pluginLoaded,current:_main2.default.current,previous:_main2.default.previous,next:_main2.default.next,init:_main2.default.init,active:_main2.default.active,slides:"jsWrapper",slide:"jsHook",dot:"jsDot",prevButton:"jsPrev",nextButton:"jsNext"},ex1=document.querySelector(".ex1"),ex1Logs=(0,_from2.default)(ex1.querySelectorAll(".log")||[]);(0,_presets.belt)(ex1,{classNames:classNames,initialSlide:3,onSlide:function(e,t,s,n){var r=e.left,a=e.right;ex1Logs.forEach(function(e){e.parentNode===t?e.style.transform="translate3d("+(100-100*(0,_easingUtils.easeOutSine)(a))+"%,0,0)":e.parentNode===s?e.style.transform="translate3d("+(100*(0,_easingUtils.easeOutSine)(r)-100)+"%,0,0)":e.parentNode===n&&(e.style.transform="translate3d("+-100*(0,_easingUtils.easeOutSine)(a)+"%,0,0)")})},onEnd:function(e,t,s){ex1Logs.forEach(function(e){e.parentNode===s&&(e.style.transform="")})}});var coverRightCustom=function(e,t){return(0,_wrapper2.default)(e,(0,_extends3.default)({},t,{onSlide:function(e,s,n,r){var a=e.left,o=e.right;n?n.style.transform="translate3d("+(100-100*(0,_easingUtils.easeOutSine)(a))+"%,0,0)":s&&(s.style.transform="translate3d("+(100-100*(0,_easingUtils.easeOutSine)(o))+"%,0,0)"),"function"==typeof t.onSlide&&t.onSlide({left:a,right:o},s,n,r)},onEnd:function(e,s,n){"function"==typeof t.onEnd&&t.onEnd(e,s,n)}}))},ex2=document.querySelector(".ex2"),ex2Logs=(0,_from2.default)(ex2.querySelectorAll(".log")||[]);coverRightCustom(ex2,{classNames:classNames,initialSlide:2,speed:600,spring:300,onSlide:function(e,t,s){var n=e.left,r=e.right;ex2Logs.forEach(function(e){e.parentNode===t?e.style.transform="translate3d("+(100-100*(0,_easingUtils.easeInQuad)(r))+"%,0,0)":e.parentNode===s&&(e.style.transform="translate3d("+(100-100*(0,_easingUtils.easeOutQuad)(n))+"%,0,0)")})},onEnd:function(e,t,s){ex2Logs.forEach(function(e){e.parentNode===s&&(e.style.transform="")})}});var coverCustom=function(e,t){return(0,_wrapper2.default)(e,(0,_extends3.default)({},t,{onSlide:function(e,s,n,r){var a=e.left,o=e.right;n?(r.style.transform="translate3d("+-100*(0,_easingUtils.easeOutSine)(o)+"%,0,0)",r.style.zIndex=2,n.style.transform="translate3d(0%,0,0)",n.style.zIndex=1):s&&(r.style.transform="",r.style.zIndex=1,s.style.zIndex=2,s.style.transform="translate3d("+(100-100*(0,_easingUtils.easeOutSine)(o))+"%,0,0)"),"function"==typeof t.onSlide&&t.onSlide({left:a,right:o},s,n,r)},onEnd:function(e,s,n){n.style.zIndex="",e.style.zIndex="",s.style.zIndex="","function"==typeof t.onEnd&&t.onEnd(e,s,n)}}))},ex3=document.querySelector(".ex3"),ex3Logs=(0,_from2.default)(ex3.querySelectorAll(".log")||[]);coverCustom(ex3,{classNames:classNames,initialSlide:2,speed:600,spring:300,onSlide:function(e,t,s,n){var r=e.left,a=e.right;t&&(t.style.backgroundPosition=100*(0,_easingUtils.easeOutBack)(a)+"% 50%"),ex3Logs.forEach(function(e){e.parentNode===t?e.style.transform="translate3d("+(100-100*(0,_easingUtils.easeInQuad)(a))+"%,0,0)":e.parentNode===s?e.style.transform="translate3d("+(100*(0,_easingUtils.easeOutQuad)(r)-100)+"%,0,0)":e.parentNode===n&&(e.style.transform="translate3d("+-100*(0,_easingUtils.easeOutQuad)(a)+"%,0,0)")})},onEnd:function(e,t,s){ex3Logs.forEach(function(e){e.parentNode===s&&(e.style.transform="")})}}),(0,_presets.belt)(document.querySelector(".belt"),{classNames:classNames}),(0,_presets.coverLeftRight)(document.querySelector(".coverLeftRight"),{classNames:classNames}),(0,_presets.coverRight)(document.querySelector(".coverRight"),{classNames:classNames}),(0,_presets.coverLeft)(document.querySelector(".coverLeft"),{classNames:classNames});
