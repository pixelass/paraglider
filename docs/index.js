...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}exports.__esModule=!0;var _extends2=require(10),_extends3=_interopRequireDefault(_extends2),_glider=require(75),_glider2=_interopRequireDefault(_glider),_config=require(74),_helpers=require(76),wrapper=function(e,t){if(e){var r=(0,_helpers.findAll)("."+t.classNames.dot),n=(0,_helpers.findFirst)("."+t.classNames.nextButton,e),i=(0,_helpers.findFirst)("."+t.classNames.prevButton,e),s=(0,_extends3.default)({},_config.PLUGIN_DEFAULTS,_config.PRESET_DEFAULTS,t,{onSlide:function(e,r,n){var i=r.next,s=r.previous,l=r.current,o=r.rest;"function"==typeof t.onSlide&&t.onSlide(e,{next:i,previous:s,current:l,rest:o},n)},onEnd:function(e,n){var i=e.next,s=e.previous,l=e.current,o=e.rest;r.forEach(function(e,r){e.classList.toggle(t.classNames.active,r===l)}),"function"==typeof t.onEnd&&t.onEnd({next:i,previous:s,current:l,rest:o},n)}}),l=new _glider2.default(s);return l.init(e),r.forEach(function(e,t){var r=function(e){return e.preventDefault(),l.goTo(t)};e.addEventListener("click",r),e.classList.toggle(s.classNames.active,t===s.initialSlide)}),n&&n.addEventListener("click",l.nextSlide),i&&i.addEventListener("click",l.prevSlide),l.destroy}};exports.default=wrapper;
