...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var _extends2=require("babel-runtime/helpers/extends"),_extends3=_interopRequireDefault(_extends2),_from=require("babel-runtime/core-js/array/from"),_from2=_interopRequireDefault(_from),_easingUtils=require("easing-utils"),_presets=require("../src/presets"),_wrapper=require("../src/presets/wrapper"),_wrapper2=_interopRequireDefault(_wrapper),_main=require("./main.css"),_main2=_interopRequireDefault(_main),classNames={pluginLoaded:_main2.default.pluginLoaded,current:_main2.default.current,previous:_main2.default.previous,next:_main2.default.next,init:_main2.default.init,active:_main2.default.active,slides:"jsWrapper",slide:"jsHook",dot:"jsDot",prevButton:"jsPrev",nextButton:"jsNext"},ex1=document.querySelector(".ex1"),ex1Logs=(0,_from2.default)(ex1.querySelectorAll(".log")||[]);(0,_presets.belt)(ex1,{classNames:classNames,initialSlide:3,onSlide:function(e,t,s,r){var a=e.left,n=e.right;ex1Logs.forEach(function(e){e.parentNode===t?e.style.transform="translate3d("+(100+100*(0,_easingUtils.easeOutSine)(n))+"%,0,0)":e.parentNode===s?e.style.transform="translate3d("+(-100-100*(0,_easingUtils.easeOutSine)(a))+"%,0,0)":e.parentNode===r&&(e.style.transform="translate3d("+100*(0,_easingUtils.easeOutSine)(n)+"%,0,0)")})},onEnd:function(e,t,s){ex1Logs.forEach(function(e){e.parentNode===s&&(e.style.transform="")})}});var coverRightCustom=function(e,t){return(0,_wrapper2.default)(e,(0,_extends3.default)({},t,{onSlide:function(e,s,r,a){var n=e.left,o=e.right;r?r.style.transform="translate3d("+(100+100*(0,_easingUtils.easeOutSine)(n))+"%,0,0)":s&&(s.style.transform="translate3d("+(100+100*(0,_easingUtils.easeOutSine)(o))+"%,0,0)"),"function"==typeof t.onSlide&&t.onSlide({left:n,right:o},s,r,a)},onEnd:function(e,s,r){"function"==typeof t.onEnd&&t.onEnd(e,s,r)}}))},ex2=document.querySelector(".ex2"),ex2Logs=(0,_from2.default)(ex2.querySelectorAll(".log")||[]);coverRightCustom(ex2,{classNames:classNames,initialSlide:2,speed:1e3,spring:500,onSlide:function(e,t,s){var r=e.left,a=e.right;console.log(r),ex2Logs.forEach(function(e){e.parentNode===t?e.style.transform="translate3d("+(100-100*(0,_easingUtils.easeInQuad)(a))+"%,0,0)":e.parentNode===s&&(e.style.transform="translate3d("+(100+-100*(0,_easingUtils.easeOutQuad)(Math.abs(r)))+"%,0,0)")})},onEnd:function(e,t,s){ex2Logs.forEach(function(e){e.parentNode===s&&(e.style.transform="")})}}),(0,_presets.belt)(document.querySelector(".belt"),{classNames:classNames}),(0,_presets.coverLeftRight)(document.querySelector(".coverLeftRight"),{classNames:classNames}),(0,_presets.coverRight)(document.querySelector(".coverRight"),{classNames:classNames}),(0,_presets.coverLeft)(document.querySelector(".coverLeft"),{classNames:classNames});
