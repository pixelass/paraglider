...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var _extends2=require(10),_extends3=_interopRequireDefault(_extends2),_multiWrapper=require(82),_multiWrapper2=_interopRequireDefault(_multiWrapper),_presets=require(80),_helpers=require(75);require(1);var _visibleSlides=require(2),_visibleSlides2=_interopRequireDefault(_visibleSlides),multiCover=function(e,s){return(0,_multiWrapper2.default)(e,(0,_extends3.default)({},s,{onInit:function(e,s){var i=(e.next,e.previous,e.current);e.rest;i.forEach(function(e,i){s[e].style.transform="translate3d("+100*i+"%,0,0)",s[e].style.zIndex=2})},onSlide:function(e,s,i,l){var t=s.next,r=s.previous,n=s.current,a=(s.rest,l.slideBy);if(null!==r)n.forEach(function(s,l){i[s].style.transform="translate3d("+(100*l+100*e)+"%,0,0)",i[s].style.zIndex=2}),r.length>0?r.forEach(function(e,s){i[e].style.transform="translate3d("+100*s+"%,0,0)",i[e].style.zIndex=1}):(i[r].style.transform="translate3d(0,0,0)",i[r].style.zIndex=1);else if(null!==t){for(var d=0;d<a;d++)i[n[d]].style.zIndex=1;n.filter(function(e,s){return s>a-1}).forEach(function(s,l){i[s].style.transform="translate3d("+(100*(l+a)-100*e)+"%,0,0)",i[s].style.zIndex=2}),t.forEach(function(s,l){i[s].style.transform="translate3d("+(100*a+100*l-100*e)+"%,0,0)",i[s].style.zIndex=3})}},onEnd:function(e,s){var i=(e.next,e.previous,e.current);e.rest;s.forEach(function(e){e.style.transform="",e.style.zIndex=""}),i.forEach(function(e,i){s[e].style.transform="translate3d("+100*i+"%,0,0)"})}}))},classNames={pluginLoaded:_visibleSlides2.default.pluginLoaded,current:_visibleSlides2.default.current,previous:_visibleSlides2.default.previous,next:_visibleSlides2.default.next,init:_visibleSlides2.default.init,active:_visibleSlides2.default.active,slides:_visibleSlides2.default.jsWrapper,slide:_visibleSlides2.default.jsSlide,dot:_visibleSlides2.default.jsDot,prevButton:_visibleSlides2.default.jsPrev,nextButton:_visibleSlides2.default.jsNext};(0,_presets.multiBelt)((0,_helpers.findFirst)("."+_visibleSlides2.default.multi1),{classNames:classNames,visibleSlides:2,slideBy:1}),(0,_presets.multiBelt)((0,_helpers.findFirst)("."+_visibleSlides2.default.multi2),{classNames:classNames,visibleSlides:4,slideBy:4}),multiCover((0,_helpers.findFirst)("."+_visibleSlides2.default.multi3),{classNames:classNames,visibleSlides:5,slideBy:2}),multiCover((0,_helpers.findFirst)("."+_visibleSlides2.default.multi4),{classNames:classNames,visibleSlides:3,slideBy:3});
